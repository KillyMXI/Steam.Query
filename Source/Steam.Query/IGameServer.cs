...
namespace Steam.Query
{
    ...
    {
        Task<IGameServerInfo> GetServerInfoAsync(bool forceRefresh = false, TimeSpan? timeout = default(TimeSpan?), bool checkPing = true);
        ...
        Task<IGameServerInfo> TryGetServerInfoAsync(bool forceRefresh = false, TimeSpan? timeout = default(TimeSpan?), bool checkPing = true);
